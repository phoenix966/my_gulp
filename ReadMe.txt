Примечания к сборке!
 ...
 позволяет подключать части кода js ,css, и любые библиотеки а также для html Используется другая библиотека gulp-file-include
...
для HTML(например svg) и не только нужно использовать:
    ...
    @@include('./components/footer.html')	- HTML -
											--------
